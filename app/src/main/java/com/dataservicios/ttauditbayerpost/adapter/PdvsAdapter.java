package com.dataservicios.ttauditbayerpost.adapter;
...
//            imageLoader = AppController.getInstance().getImageLoader();
       NetworkImageView thumbNail = (NetworkImageView) convertView.findViewById(R.id.thumbnail);
        ...
        TextView tipo = (TextView) convertView.findViewById(R.id.tvType);
        TextView cadenaRuc = (TextView) convertView.findViewById(R.id.tvCadenaRuc);
       ...
       // thumbNail.setImageUrl(m.getThumbnailUrl(), imageLoader);
        ...
        tipo.setText("Tipo: " + m.getType());
        cadenaRuc.setText("CadenaRuc: " + m.getCadenaRuc());
