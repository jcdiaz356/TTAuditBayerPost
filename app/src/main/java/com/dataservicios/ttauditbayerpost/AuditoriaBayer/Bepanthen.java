 ...
 */
public class Bepanthen extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = "Bepanthen";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bepanthen);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("BEPANTHEN CREMA X 30 ");
        ...
        bt_guardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (contado_control > 3) {
                    Toast.makeText(MyActivity, "Debe seleccionar maximo 2 opciones", Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if (cbProducto.isChecked()) {
                    ...
                    if(etProducto.getText().equals("")){
                        ...
                        is_recomieda=1;
                        vProducto = 1;
                        oProducto = String.valueOf(poll_id_2) + "i" + "-" + etProducto.getText().toString();
...
//                }
                ...
                if (cbA.isChecked()) {
                    if(etA.getText().equals("")){
                        ...
                        vA = 1;
                        oA = String.valueOf(poll_id_2) + "j" + "-" + etA.getText().toString();
                    }
                }
                if (cbB.isChecked()) {
