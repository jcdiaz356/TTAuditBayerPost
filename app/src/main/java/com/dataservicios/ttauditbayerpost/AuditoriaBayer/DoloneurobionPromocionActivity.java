...
public class DoloneurobionPromocionActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doloneurobion_promocion);
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                if(is_sino==1) {
                    ...
                    intent = new Intent(MyActivity, DoloneurobionActividadesActivity.class);
                    ...
                    Intent intent;
                    // intent = new Intent(MyActivity, CambiarApronaxActivity.class);
                    intent = new Intent(MyActivity, DoloneurobionVisitaActivity.class);
                    intent.putExtras(argRuta);
                    startActivity(intent);
                    finish();
                }
