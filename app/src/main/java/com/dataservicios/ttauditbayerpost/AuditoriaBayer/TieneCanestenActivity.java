...
public class TieneCanestenActivity extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = TieneApronaxActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tiene_canesten);
        ...
        poll_id = GlobalConstant.poll_id[9]; //¿Se encuentra abierto el establecimiento?
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                if(is_sino==1) {
                    ...
                    Intent intent;
                    intent = new Intent(MyActivity, PorqueNoTieneCanesteActivity.class);
