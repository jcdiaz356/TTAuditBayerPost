...
public class CuantaPastillaBlisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cuanta_pastilla_blister);
        ...
        radioButtonArray[0].setText("8");
        radioButtonArray[1].setText("10");
        radioButtonArray[2].setText("Otros");
        ...
        radioButtonArray[2].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Si", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(radioButtonArray[2].isChecked()) commentOptions = etCommentOption.getText().toString(); else comentario="" ;
    ...
    class loadPoll extends AsyncTask<Void, Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                intent = new Intent(MyActivity, PrecioPastillaBlisterActivity.class);
