 ...
 */
public class Gynocanesten extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = "Gynocanesten";
    ...
    private EditText et_Comentario, et_ComentarioOtros, etProducto ,etTienda, etA,etB,etC, etD;
    private TextView tv_ComentarioOtros;
    private TextView tv_Pregunta, tvStock;
    private CheckBox cbTienda,cbProducto , cbA,cbB,cbC,cbD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gynocanesten);
...
//        poll_id = 72 , solo para exhibiciones de bayer, directo de la base de datos
        ...
        poll_id = 153; //SE RECOMIENDA EL PRODUCTO
        poll_id_2 = 154; //QUE PRODUCTO RECOMENDO
        poll_id_3 = 155; //STOcK
        ...
        if(tipo.equals("CADENA")) {
            ...
            if(cadenaruc.equals("INKAFARMA")){
                cbTienda.setText("Clotrival");
            }
            if(cadenaruc.equals("Fasa-Mifarma")){
                cbTienda.setText("Micotrin crema ");

            }
            if(cadenaruc.equals("ARCANGEL")){
                cbTienda.setText("Gynoflagymed ");
            }

            if(cadenaruc.equals("B&S")){
                cbTienda.setText("Gynofem ");
            }
            ...
            public void onClick(View v) {
                ...
                if (cbProducto.isChecked()) {
                    ...
                    if(etProducto.getText().equals("")){
                        ...
                        is_recomieda=1;
                        vProducto = 1;
                        oProducto = String.valueOf(poll_id_2) + "af" + "-" + etProducto.getText().toString();
                ...
                if (cbTienda.isChecked()) {
                    if(cbTienda.getText().equals("")){
                        ...
                        if(cadenaruc.equals("ARCANGEL")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "y";
                        }

                        if(cadenaruc.equals("B&S")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "z";
                        }
                ...
                if (cbA.isChecked()) {
                    if(etA.getText().equals("")){
                        ...
                        vA = 1;
                        oA = String.valueOf(poll_id_2) + "aa" + "-" + etA.getText().toString();
                    }
                }
                if (cbB.isChecked()) {
                    if(etB.getText().equals("")){
                        ...
                        vB = 1;
                        oB = String.valueOf(poll_id_2) + "ab"  + "-" + etB.getText().toString();
                ...
                if (cbC.isChecked()) {
                    if(etC.getText().equals("")){
                        ...
                        vC = 1;
                        oC = String.valueOf(poll_id_2) + "ag" + "-" + etC.getText().toString();
                ...
                totalValores = vProducto + vTienda + vA + vB + vC  ;
                totalOption = oProducto + "|" + oTienda + "|" + oA + "|" + oB + "|" + oC  ;
