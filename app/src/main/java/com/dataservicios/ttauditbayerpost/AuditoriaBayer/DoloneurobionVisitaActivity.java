...
public class DoloneurobionVisitaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doloneurobion_visita);
        ...
        //poll_id = 562;
        poll_id = GlobalConstant.poll_id[14];
        ...
        radioButtonArray = new RadioButton[4];
        ...
        radioButtonArray[0].setText("1 vez a la semana");
        radioButtonArray[1].setText("Quincenal");
        radioButtonArray[2].setText("Mensual");
        radioButtonArray[3].setText("Otros");
        ...
        radioButtonArray[3].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Si", new DialogInterface.OnClickListener()
                {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(radioButtonArray[3].isChecked()) commentOptions = etCommentOption.getText().toString(); else comentario="" ;
