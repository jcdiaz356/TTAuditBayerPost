 ...
 */
public class Berocca extends Activity {

    private Activity MyActivity = this ;
    private static final String LOG_TAG = "Beroca";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.berocca);
        getActionBar().setDisplayHomeAsUpEnabled(true);
        getActionBar().setTitle("Berocca");
...
//        poll_id = 72 , solo para exhibiciones de bayer, directo de la base de datos
        ...
        if(tipo.equals("CADENA")) {
            ...
            if(cadenaruc.equals("INKAFARMA")){
                cbTienda.setText("Oramin ");
            }
            if(cadenaruc.equals("Fasa-Mifarma")){
                cbTienda.setText("Multidayli");

            }
            if(cadenaruc.equals("ARCANGEL")){
                cbTienda.setText("Nutrastres");
            }

            if(cadenaruc.equals("B&S")){
                cbTienda.setText("Energy Forte");
            }
            ...
            public void onClick(View v) {
                ...
                if (cbProducto.isChecked()) {
                    ...
                    if(etProducto.getText().equals("")){
                        ...
                        is_recomieda=1;
                        vProducto = 1;
                        oProducto = String.valueOf(poll_id_2) + "ag" + "-" + etProducto.getText().toString();
                ...
                if (cbTienda.isChecked()) {
                    if(cbTienda.getText().equals("")){
                        ...
                        if(cadenaruc.equals("ARCANGEL")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "aa";
                        }

                        if(cadenaruc.equals("B&S")){
                            vTienda = 1;
                            oTienda = String.valueOf(poll_id_2) + "ab";
                        }
                ...
                if (cbA.isChecked()) {
                    if(etA.getText().equals("")){
                        ...
                        vA = 1;
                        oA = String.valueOf(poll_id_2) + "ac" + "-" + etA.getText().toString();
                    }
                }
                if (cbB.isChecked()) {
                    if(etB.getText().equals("")){
                        ...
                        vB = 1;
                        oB = String.valueOf(poll_id_2) + "ad"  + "-" + etB.getText().toString();
                ...
                if (cbC.isChecked()) {
                    if(etC.getText().equals("")){
                        ...
                        vC = 1;
                        oC = String.valueOf(poll_id_2) + "ae" + "-" + etC.getText().toString();
                ...
                if (cbD.isChecked()) {
                    if(etD.getText().equals("")){
                        ...
                        vD = 1;
                        oD = String.valueOf(poll_id_2) + "af" + "-" + etD.getText().toString();
                ...
                if (cbE.isChecked()) {
                    if(etE.getText().equals("")){
                        ...
                        vE = 1;
                        oE = String.valueOf(poll_id_2) + "ah" + "-" + etE.getText().toString();
