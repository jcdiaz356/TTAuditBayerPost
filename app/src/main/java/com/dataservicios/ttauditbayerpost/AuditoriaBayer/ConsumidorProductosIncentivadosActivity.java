...
public class ConsumidorProductosIncentivadosActivity extends Activity {
    private Activity MyActivity = this ;
    private static final String LOG_TAG = TieneNaproxenoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consumidor_productos_incentivados);
        ...
        poll_id = GlobalConstant.poll_id[11]; //¿Se encuentra abierto el establecimiento?
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                if(is_sino==1) {
                    ...
                    intent = new Intent(MyActivity, IntentaProductosIncentivadosActivity.class);
