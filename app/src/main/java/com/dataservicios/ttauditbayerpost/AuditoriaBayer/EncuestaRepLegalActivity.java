...
public class EncuestaRepLegalActivity extends Activity {

    private Activity myActivity = this ;
    private static final String LOG_TAG = EncuestaRepLegalActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_encuesta_rep_legal);
    ...
    class loadPoll extends AsyncTask<Void, Integer , Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result){
                ...
                Intent intent = new Intent(myActivity, EncuestaDiasInformacionActivity.class);
...
//        overridePendingTransition(R.anim.anim_slide_in_right,R.anim.anim_slide_out_right);
    ...
    private void createRadioButtonOptions(){
        ...
        radioButton1Array = new RadioButton[4];

        radioButton1Array[0] = new RadioButton(this);
        radioButton1Array[0].setText("Propietario/Representante legal");
        ...
        radioButton1Array[1].setText("Director Técnico");
        radioButton1Array[1].setTag("b");
        rgOptions.addView(radioButton1Array[1]);

        radioButton1Array[2] = new RadioButton(this);
        radioButton1Array[2].setText("PQF Asistente");
        radioButton1Array[2].setTag("c");
        rgOptions.addView(radioButton1Array[2]);

        radioButton1Array[3] = new RadioButton(this);
        radioButton1Array[3].setText("Tecnico de Farmacia");
        radioButton1Array[3].setTag("d");
        rgOptions.addView(radioButton1Array[3]);
