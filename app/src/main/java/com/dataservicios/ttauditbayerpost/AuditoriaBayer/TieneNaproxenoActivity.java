...
public class TieneNaproxenoActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tiene_naproxeno);
        ...
        poll_id = GlobalConstant.poll_id[6]; //¿Se encuentra abierto el establecimiento?
                ...
                // loadLoginActivity();
                 if(is_sino==1) {
                   ...
                   // intent = new Intent(MyActivity, CambiarApronaxActivity.class);
                    intent = new Intent(MyActivity, CuantoCompraNaproxenoActivity.class);
